        ...
        <section className="relative overflow-hidden bg-background pt-20 pb-20 md:pt-32 md:pb-32">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center space-y-8">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted border border-border text-primary text-sm font-semibold animate-in fade-in slide-in-from-bottom-2 duration-700">
                        <Heart className="h-4 w-4 fill-primary" />
                        <span>Support Local Families in Fox River Grove</span>
                    </div>
                    ...
                    <h1 className="mx-auto max-w-4xl text-5xl md:text-7xl font-extrabold tracking-tight text-foreground leading-[1.1] animate-in fade-in slide-in-from-bottom-4 duration-1000">
                        {campaignName ? (
                            ...
                            <>Small Acts of Kindness, <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80">Large Impacts</span></>
                        )}
                    </h1>
                    ...
                    <p className="mx-auto max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200">
                        Join our community-driven effort to ensure every family in our neighborhood has a bright and memorable holiday season.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
                        <Button
                            ...
                            className="bg-foreground text-background hover:bg-foreground/90 h-14 px-8 text-md font-bold rounded-2xl shadow-xl shadow-border/50 transition-all hover:scale-[1.01] group"
                        >
                            Browse Needs
