    ...
    if (!activeCampaign) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
                ...
                <h2 className="text-xl font-semibold text-slate-900">No Active Campaign</h2>
    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight uppercase">Families</h1>
                    <p className="text-slate-500">Manage participating families for &quot;{activeCampaign.name}&quot;.</p>
                </div>
